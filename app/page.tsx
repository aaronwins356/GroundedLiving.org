        ...
        <div className="grid gap-8 lg:grid-cols-[1.1fr_1fr]">
          <div className="flex flex-col justify-center gap-6 p-10 sm:p-14">
            ...
            <p className="max-w-xl text-base leading-relaxed text-accent-soft sm:text-lg">
              Weekly rituals, gentle reminders, and grounded guidance to help you create a calm, intentional life. Grab a cup
              of tea and stay awhile.
            </p>
      ...
      <section className="space-y-10">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <h2 className="text-3xl font-semibold text-accent">Featured stories</h2>
          </div>
        ...
        <div className="space-y-5">
          ...
          {aboutSnippet.length ? (
            ...
            <p className="max-w-xl text-base leading-relaxed text-accent-soft">
              Create an “About” page inside Sanity to introduce yourself and welcome new readers. A short bio will show up
              here automatically.
            </p>
          )}
